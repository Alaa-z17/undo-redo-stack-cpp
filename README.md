...
Undo Stack: Every time a new text is written, the current state is pushed onto this stack before updating.

Redo Stack: When an "Undo" is performed, the current state is moved here to allow for "Redo" functionality.
